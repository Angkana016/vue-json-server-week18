...
const logOut = async () => {
    localStorage.clear()
    await router.push({ name: 'signln' })
}

</script>

<template>
    <nav class="navbar navbar-expand-lg navbar-dark shadow" style="background: #2c96de;">
        <div class="container">
            <RouterLink :to="{ name: 'home' }" class="navbar-brand">เรื่องของนก🕊️</RouterLink>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <i class="bi bi-bank2 me-1"></i>นกที่สวยที่สุดในโลก
                        </a>

                        <ul class="dropdown-menu">
                            <li>
                                <RouterLink :to="{ name: 'wonders' }" class="dropdown-item">นกที่สวยที่สุดในโลก
                                </RouterLink>
                            </li>
                            <li>
                                <RouterLink :to="{ name: 'add-wonder' }" class="dropdown-item">เพิ่มนกที่สวยที่สุดในโลก
                                </RouterLink>
                            </li>
                            <li><a class="dropdown-item" href="#">แก้ไขนกที่สวยที่สุดในโลก</a></li>
                            <li><a class="dropdown-item" href="#">ลบนกที่สวยที่สุดในโลก</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="https://www.wonderspodcast.com/wonders">เว็บไซต์ นกที่สวยที่สุดในโลก</a></li>
                        </ul>
                    </li>
